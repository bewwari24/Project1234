...
class View extends \Gcms\View
{
    ...
    public function render($index)
    {
        ...
        if (is_file(ROOT_PATH.DATA_FOLDER.'images/logo.png')) {
            $logo = '<img src="'.WEB_URL.DATA_FOLDER.'images/logo.png" alt="Logo">';
        }
        $logo .= (!empty(self::$cfg->company_name) && !empty(self::$cfg->show_title_logo) ? self::$cfg->company_name : '');
        // repair.html
        ...
        $template->add(array(
            ...
            '/%CURRENCY_UNIT%/' => Language::find('CURRENCY_UNITS', '', self::$cfg->currency_unit),
        ));
        // คืนค่า HTML
